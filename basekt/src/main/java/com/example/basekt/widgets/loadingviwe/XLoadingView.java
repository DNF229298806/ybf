package com.example.basekt.widgets.loadingviwe;
...
public class XLoadingView extends FrameLayout {
     ...
     * @param state
     */
    @BindingAdapter("xState")
    public static void setState(XLoadingView view, int state) {
        switch (state) {
     ...
     * @param listener
     */
    @BindingAdapter("xRetryClick")
    public static void setRetryClickListener(XLoadingView view,OnClickListener listener) {
